...
export const BLOCKS = [
  ...
  { name: "grass", color: 0x6f8f4a, solid: true },
  { name: "dirt", color: 0x6b5236, solid: true },
  { name: "stone", color: 0x8a8378, solid: true },
  { name: "cobble", color: 0x736c62, solid: true },
  { name: "plaster", color: 0xd8c9a8, solid: true },
  { name: "timber", color: 0x6d4a2f, solid: true },
  { name: "roof", color: 0x6a6bb0, solid: true },
  { name: "sand", color: 0xbfae86, solid: true },
  { name: "plank", color: 0xa97c4b, solid: true },
